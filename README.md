<h1 align="center">Hello 👋 I am Geetansh Sharma</h1>

## About Me
```js
{
  title: 'Student',
  techInterests: ['OpenSource', 'DevOps', 'Cloud'],
  birthDay: {
    day: 5,
    month: 11
  },
  ...
  social: {
    linkedin: 'https://www.linkedin.com/in/geetansh-sharma',
    gmail: 'geetanshsharma2018@gmail.com',
    medium: 'https://geetanshsharma2018.medium.com',
